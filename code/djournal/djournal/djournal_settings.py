...
TITLE = getattr(settings, 'DJOURNAL_TITLE', 'DJournal')
SYNDICATION_DESCRIPTION = getattr(settings, 'DJOURNAL_SYNDICATION_DESCRIPTION', 'Django Blogging Engine')
...
RICHTEXT_EDITOR = getattr(settings, 'DJOURNAL_RICHTEXT_EDITOR', '')
