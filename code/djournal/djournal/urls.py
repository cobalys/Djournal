...
urlpatterns = patterns(
    '',
    url(r'^permalink/(?P<permanent_id>\d+)$', entry_permalink, name='djournal-entry-permalink'),
    ...
    url(r'^rss/entries/$', RssEntries(), name='djournal-rss-entries'),
    url(r'^rss/entries/tag/(?P<tag_id>\d+)/$', RssEntriesByTag(), name='djournal-rss-entries-tag'),
