...
'''
from djournal.helpers import generation_utils

def generation_signal(sender, **kwargs):
    generation_utils.generate_date_menu()
    generation_utils.generate_tag_files()